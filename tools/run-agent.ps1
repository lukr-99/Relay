<#
  run-agent.ps1 — build and launch the DeckForge Windows agent.
...
$proj = Join-Path $repo "agent\DeckForge.Agent\DeckForge.Agent.csproj"
...
& (Join-Path $repo "agent\DeckForge.Agent\bin\$config\net10.0-windows\DeckForge.Agent.exe")
